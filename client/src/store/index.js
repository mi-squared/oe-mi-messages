  ...
  actions: {
    ...
    fetchAllMessageFilters ({ state, commit }) {
      return new Promise((resolve, reject) => {
        ...
        axios.get('/interface/modules/custom_modules/oe-mi-messages/index.php?action=message!fetch_all_message_filters')
          .then(function (response) {
    ...
    fetchAllUsers ({ state, commit }) {
      return new Promise((resolve, reject) => {
        ...
        axios.get('/interface/modules/custom_modules/oe-mi-messages/index.php?action=message!fetch_all_users')
          .then(function (response) {
